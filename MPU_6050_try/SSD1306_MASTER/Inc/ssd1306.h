...
#define hi2c_x hi2c1  // вибраний інтерфейс hi2c1 або  hi2c2
...
char ch_nums (uint8_t num);

char* convert_from_char_to_uint16_t(uint16_t number);

void clear_buffer(void);

void SSD1306_UA_Print(char *str, FontDef_t* Font, SSD1306_COLOR_t color);  //вивід українських букв
